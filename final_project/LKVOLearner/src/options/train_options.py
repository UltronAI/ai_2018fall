...
class TrainOptions(BaseOptions):
    def initialize(self):
        ...
        self.parser.add_argument('--lambda_S', '-s', type=float, default=.01, help='smoothness cost weight')
        self.parser.add_argument('--lambda_E', '-e',  type=float, default=.01, help='explainable mask regulariation cost weight')
        ...
        self.parser.add_argument('--momentum', type=float, default=0.9, help='momentum for sgd and alpha param for adam')
        self.parser.add_argument('--beta', type=float, default=0.999, help='beta param for adam')
        self.parser.add_argument('--weight-decay', type=float, default=0, help='weight decay')
        self.parser.add_argument('--gpu-id', '-g', type=int, default=0)
        self.isTrain = True
